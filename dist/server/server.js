...
import { IndexController, NimblewearController, JollofController } from '../controllers/index.js';
const server = express();
const wss = new WebSocketServer({
    noServer: true
});
const defaultController = new IndexController(mongoClient, 'Mydeas');
const nimbelwearController = new NimblewearController(mongoClient, 'NimbelWear');
...
server.use('/', defaultController.router);
